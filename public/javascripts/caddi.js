...
CloudFlare.define( 'caddi', 
        [   'caddi/config',     'cloudflare/owl',   'cloudflare/jquery1.7' ], 
function(   cfg,                owl,                jQuery ) {

    var $ = jQuery;                 // need this!
    ...
    var set_ad_data = function() {
        ...
        a1.onclick = function() {
            ...
            console.log( 'closing; about to fire OWL');
        ...
        console.log( "set_ad_data() completed" );
    };
...
/** end waypoints.js ***/
    ...
    $('#cfads').waypoint( function(event, direction) {
